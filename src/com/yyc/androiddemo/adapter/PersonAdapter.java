	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(mContext).inflate(
					R.layout.listitem_personlist, null);
			holder = new ViewHolder();

			holder.personName = (TextView) convertView
					.findViewById(R.id.textview_personlist_listitem_name);
			holder.personAge = (TextView) convertView
					.findViewById(R.id.textview_personlist_listitem_age);
			holder.personSex = (TextView) convertView
					.findViewById(R.id.textview_personlist_listitem_sex);
